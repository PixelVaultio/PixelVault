...
RESOURCES += src/qt/pixel.qrc src/qt/pixel_locale.qrc

TRANSLATIONS += src/qt/locale/pixel_bg.ts \
                src/qt/locale/pixel_de.ts \
                src/qt/locale/pixel_en.ts \
                src/qt/locale/pixel_es.ts \
                src/qt/locale/pixel_fi.ts \
                src/qt/locale/pixel_fr.ts \
                src/qt/locale/pixel_it.ts \
                src/qt/locale/pixel_ja.ts \
                src/qt/locale/pixel_pl.ts \
                src/qt/locale/pixel_pt.ts \
                src/qt/locale/pixel_ru.ts \
                src/qt/locale/pixel_sk.ts \
                src/qt/locale/pixel_sv.ts \
                src/qt/locale/pixel_vi.ts \
                src/qt/locale/pixel_zh_CN.ts \
                src/qt/locale/pixel_zh_TW.ts
