...
This means one can have an always-on pixeld instance running, and another local pixeld/pixel-qt instance which connects to this node and receives blocks from it.
