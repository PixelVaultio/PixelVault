...
In order to support loading of multiple wallets in pixel-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pixel.cpp.
...
Changes to pixel.cpp
----------------------
pixel.cpp is the entry point into pixel-qt, and as such, will require some minor modifications to provide hooks for
