...
This mechanism has been integrated into Bitcore-Node-Pixel which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Pixel-Project/insight-api-pixel#web-socket-api](https://github.com/Pixel-Project/insight-api-pixel#web-socket-api) 
* API: [https://github.com/Pixel-Project/insight-api-pixel#swifttx-transactions](https://github.com/Pixel-Project/insight-api-pixel#swifttx-transactions) 
...
By default, the Pixel Vault daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pixel Vault daemon:
