...
#error Client version information missing: version is not defined by pixel-config.h or in any other way
#endif
...
/**
 * pixeld-res.rc includes this file, but it cannot cope with real c++ code.
