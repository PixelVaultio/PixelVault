...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pixel Vault pixel-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pixel-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pixel transaction") + "\n" +
                               "  pixel-tx [options] -create [commands]   " + _("Create hex-encoded pixel transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pixel transaction
