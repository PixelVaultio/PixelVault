...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 51470;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Pixel starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Pixel: 1 day
        nTargetSpacing = 1 * 60;  // Pixel: 1 minute
        nMaturity = 100;
        ...
        nBlockZerocoinV2 = 9999; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("024249c735aad25ac569b6841c251e40dce7981e00bcde9f0eb20f222e72acb161") << OP_CHECKSIG;
...
//        vSeeds.push_back(CDNSSeedData("178.254.23.111", "178.254.23.111"));           // Single node address*/
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zpxl to be stakable
...
//        std::cout << "Merkle Root Hash:\t" << genesis.hashMerkleRoot.GetHex() << std::endl;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet pixel addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet pixel script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet pixel BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet pixel BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet pixel BIP44 coin type is '1' (All coin's testnet default)
        ...
        strSporkKey = "024249c735aad25ac569b6841c251e40dce7981e00bcde9f0eb20f222e72acb161";
        strSporkKeyOld = "024249c735aad25ac569b6841c251e40dce7981e00bcde9f0eb20f222e72acb161";
        strObfuscationPoolDummyAddress = "y57cqfGRkekRyDRNeJiLtYVEbvhXrNbmox";
        nStartMasternodePayments = 1633204549; //Fri, 09 Jan 2015 21:05:58 GMT
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Pixel: 1 day
        nTargetSpacing = 1 * 60;        // Pixel: 1 minutes
