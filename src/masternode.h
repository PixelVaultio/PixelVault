...
#define MASTERNODE_COLLATERAL_COINS 5000
...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 10000 PXL, signature to prove
