...
extern UniValue setzpxlseed(const UniValue& params, bool fHelp);
extern UniValue getzpxlseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzpxl(const UniValue& params, bool fHelp);
extern UniValue dzpxlstate(const UniValue& params, bool fHelp);
