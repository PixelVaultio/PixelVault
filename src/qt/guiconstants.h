...
/* Pixel GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Pixel"
#define QAPP_ORG_DOMAIN "pixel.org"
#define QAPP_APP_NAME_DEFAULT "Pixel-Qt"
#define QAPP_APP_NAME_TESTNET "Pixel-Qt-testnet"
