                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzPXLPathCustom = GetArg("-zpxlbackuppath", "");
    ...
    if(!strzPXLPathCustom.empty()) {
        ui->wallet_customzpxlbackuppath->setText(QString::fromStdString(strzPXLPathCustom));
        ui->wallet_customzpxlbackuppath_label->setVisible(true);
        ui->wallet_customzpxlbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzPXLPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Pixel RPC console.") + "<br>" +
