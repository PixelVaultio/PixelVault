                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pixel Vault") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pixel address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pixel: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPXL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pixel Vault"), this);
    aboutAction->setStatusTip(tr("Show information about Pixel Vault"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pixel"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pixel addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pixel addresses"));
    ...
    openAction->setStatusTip(tr("Open a Pixel: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pixel Vault help message to get a list with possible Pixel command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pixel Vault client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pixel network", "", count));
}
...
{
    QString strTitle = tr("Pixel Vault"); // default title
