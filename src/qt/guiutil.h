...
/** Utility functions used by the Pixel Qt UI.
 */
namespace GUIUtil
{
...
// Render Pixel addresses in monospace font
...
// Parse "pixel:" URI into recipient object, return true on successful parsing
