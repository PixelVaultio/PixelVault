...
#   c) node1 mines 32 blocks, so now node 0 has 60001pxl, node 1 has 4250pxl, node2 has none.
#   d) node0 sends 601 pxl to node2, in two transactions (301 pxl, then 300 pxl).
